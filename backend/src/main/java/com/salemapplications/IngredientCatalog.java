...
public class IngredientCatalog {
    ...
    public IngredientCatalog(Integer id, String name, double amount, String unit, String category, double calories, double protein, double fat, double carbohydrates, double fibre) {
        this.id = id;
        this.name = name;
        this.amount = amount;
        this.unit = unit;
